      ...
      <table class="layui-table layui-form">
        ...
        <tbody class="x-cate">
          <tr cate-id='1' fid='0' >
            ...
            <td class="td-manage">
              <button class="layui-btn layui-btn layui-btn-xs"  onclick="x_admin_show('编辑','/BackCate/adminEdit.view')" ><i class="layui-icon">&#xe642;</i>编辑</button>
              <button class="layui-btn layui-btn-warm layui-btn-xs"  onclick="x_admin_show('编辑','/BackCate/adminEdit.view')" ><i class="layui-icon">&#xe642;</i>添加子栏目</button>
