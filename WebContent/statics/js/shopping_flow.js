...
function checkOrderForm(frm) {
	...
	have_alipay = false;
	if (frm.elements['www_wrzc_net_bank']) {
		for (var iii = 0; iii < frm.elements['www_wrzc_net_bank'].length; iii++) {
			if (frm.elements['www_wrzc_net_bank'][iii].checked) {
				have_alipay = true;
			}
		}
		/* 代码增加_end By www.wrzc.net */
