...
public class Product implements Serializable {
	//`salesVolume`,`evaluateSales`,`giveIntegral`,`model`,`colour`,`isDelete`
	private Integer id;//ID
	private String name;//商品名
	private String description;//描述
	private Float price;//单价
	private Float bazaarPrice;//市场单价
	...
	private Integer evaluateSales;//评价次数
	private Integer giveIntegral;//赠送积分
	private String model;//型号
	private String colour;//颜色
	private Integer isDelete;//1：正常0：下架
	...
	public Integer getEvaluateSales() {
		return evaluateSales;
	}
	public void setEvaluateSales(Integer evaluateSales) {
		this.evaluateSales = evaluateSales;
	}
