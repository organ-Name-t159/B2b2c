...
public class GetMessageCode {
    ...
    private static final String ACCOUNT_SID="f66ed8c91af744629d13f9b067679a3b";
    private static final String AUTH_TOKEN="12a9f50d114145d8a793ec0509b39033";
    ...
    public static String getCode(String phone){
        ...
        String tamp="【家家购物】您的验证码为"+rod+"，请于{2}分钟内正确输入，如非本人操作，请忽略此短信。";//这里一定要与新建模板中的短信内容一致，一个空格都不能多，否者短信打死都发不过去哦
